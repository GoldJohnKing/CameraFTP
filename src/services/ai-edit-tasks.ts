...
export function mapToState(state: TaskProgressState): AiEditProgressState {
  return { ...state, isEditing: state.isActive };
}

const aiEdit = createTaskProgressService<AiEditProgressEvent>({
...
export const aiEditStore = aiEdit.store;
export const ensureAiEditListener = () => aiEdit.ensureListener();
